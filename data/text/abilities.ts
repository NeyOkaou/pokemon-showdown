export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	megalauncher: {
		name: "Mega Launcher",
		desc: "This Pokemon's pulse and beam moves have their power multiplied by 1.5. Heal Pulse restores 3/4 of a target's maximum HP, rounded half down.",
		shortDesc: "This Pokemon's pulse and beam moves have 1.5x power. Heal Pulse heals 3/4 target's max HP.",
	},
	merciless: {
		name: "Merciless",
	...
	windpower: {
		name: "Wind Power",
		desc: "This Pokemon's wind-based attacks have 1.3x power. Gains the Charge effect when it takes a hit from a wind move or when Tailwind begins on this Pokemon's side.",
		shortDesc: "This Pokemon's wind-based attacks have 1.3x power. Gains the Charge effect when hit by a wind move or Tailwind begins.",
