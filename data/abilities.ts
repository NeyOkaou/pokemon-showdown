...
export const Abilities: import('../sim/dex-abilities').AbilityDataTable = {
	...
	normalize: {
		...
		onModifyType(move, pokemon) {
			const noModifyType = [
				'hiddenpower', 'judgment', 'multiattack', 'naturalgift', 'revelationdance', 'struggle', 'technoblast', 'terrainpulse', 'weatherball','pupunch',
			];
...
//		onUpdate(pokemon) {
//			if (pokemon.status === 'brn') {
//				this.add('-activate', pokemon, 'ability: Mud Coat');
//				pokemon.cureStatus();
//			}
//		},
//		onSetStatus(status, target, source, effect) {
//			if ((effect as Move)?.status) {
//				this.add('-immune', target, '[from] ability: Mud Coat');
//			}
//			return false;
//		},
//		onStart(pokemon) {
