export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	gerbuzz: {
		...
		abilities: { 0: "Static", 1: "Sand Rush", H: "Lightning Rode" },
		heightm: 0.25,
		weightkg: 1.2,
		color: "Yellow",
		evos: ["Teslanten"],
	...
	omegama: {
		...
		types:["Electric", "Ghost"],
		baseStats: { hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100 },
		abilities: { 0: "Download", 1: "Magnet Pull", H: "Magic Bounce" },
		heightm: 2,
		weightkg: 300,
		color: "Black",
		eggGroups: ["Mineral"],
	...
	denkid: {
		...
		abilities: { 0: "Static", 1: "Volt Absorb", H: "Electric Surge", S: "Flame Body" },
		heightm: 0.2,
		weightkg: 0.1,
		color: "Yellow",
		evos: ["Denkigan"],
