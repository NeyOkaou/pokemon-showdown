export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	emprism: {
		...
		abilities: { 0: "Forewarn", 1: "Levitate", H: "Protean", S: "Magic Bounce"},
		heightm: 0.11,
		weightkg: 100,
		color: "Grey",
		evos: ["Prismunter"],
	...
	prismunter: {
		...
		types: ["Rock", "Psychic"],
		gender: "N",
		baseStats: { hp: 65, atk: 72, def: 92, spa: 105, spd: 50, spe: 141 },
		abilities: { 0: "Forewarn", 1: "Prism Armor", H: "Protean", S: "Magic Bounce"},
		heightm: 2.16,
		weightkg: 135,
		color: "Grey",
		prevo: "Emprism",
