export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	primitronc: {
		...
		abilities: { 0: "Pressure", 1: "Forewarn", H: "Water Absorb", S: "Leaf Guard"},
		heightm: 0.32,
		weightkg: 6,
		evos: ["Filicolith"],
		color: "White",
	...
	larvambre: {
		...
		abilities: { 0: "Vampire", 1: "Swarm", H: "Compound Eyes"},
		heightm: 1,
		weightkg: 50,
		evos: ["Aggrestik"],
		color: "Orange",
	...
	aggrestik: {
		...
		types: ["Bug", "Rock"],
		genderRatio: { M: 0.9, F: 0.1 },
		baseStats: { hp: 50, atk: 145, def: 45, spa: 105, spd: 25, spe: 125 },
		abilities: { 0: "Vampire", 1: "Swarm", H: "Compound Eyes"},
		heightm: 2,
		weightkg: 86,
		prevo: "Larvambre",
