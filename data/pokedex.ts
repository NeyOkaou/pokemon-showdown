export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	ostenssy: {
		...
		types: ["Ghost", "Rock"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 35, atk: 50, def: 71, spa: 40, spd: 55, spe: 15 },
		abilities: { 0: "Rock Head", 1: "Cursed Body", H: "Sturdy", S: "Fragmentate"},
		heightm: 0.57,
		weightkg: 74,
		color: "Grey",
		eggGroups: ["Mineral", "Amorphous"],
	...
	rancossor: {
		...
		types: ["Ghost", "Rock"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 50, atk: 95, def: 75, spa: 86, spd: 76, spe: 65 },
		abilities: { 0: "Rock Head", 1: "Cursed Body", H: "Solid Rock", S: "Fragmentate"},
		heightm: 1.21,
		weightkg: 127,
		color: "Grey",
		eggGroups: ["Mineral", "Amorphous"],
	...
	mossemeros: {
		...
		types: ["Ghost", "Rock"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 81, atk: 123, def: 87, spa: 58, spd: 134, spe: 52 },
		abilities: { 0: "Rock Head", 1: "Cursed Body", H: "Solid Rock", S: "Fragmentate"},
		heightm: 1.31,
		weightkg: 231,
		color: "Grey",
