...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			'Aipom','Daemonix', 'Basculin-White-Striped', 'Cutiefly', 'Diglett-Base', 'Dunsparce', 'Duraludon', 'Flittle', 'Gastly', 'Girafarig', 'Gligar',
			'Magby', 'Meditite', 'Misdreavus', 'Murkrow', 'Porygon', 'Qwilfish-Hisui', 'Rufflet', 'Scraggy', 'Scyther', 'Sneasel', 'Sneasel-Hisui',
			'Snivy', 'Stantler', 'Voltorb-Hisui', 'Vulpix', 'Vulpix-Alola', 'Yanma', 'Moody', 'Heat Rock', 'Baton Pass', 'Sticky Web','Sonicboom','Dragonrage','Lumini'
		],
	},//daemonix
	{
		name: "[Gen 9] Monotype",
	...
	{
        name: "[Gen 9] VGC Mood Reg R",
        mod: 'gen9',
        gameType: 'doubles',
        searchShow: false,
        bestOfDefault: true,
        ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Min Source Gen = 9', 'VGC Timer', 'Open Team Sheets'],
        banlist: ['Bisorgue', 'Celestial','Rhumaggro'],
    },
	{
        name: "[Gen 9] VGC Mood Reg B",
        mod: 'gen9',
        gameType: 'doubles',
        searchShow: false,
        bestOfDefault: true,
