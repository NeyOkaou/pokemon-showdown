...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: ['Crucibellite', 'Rage Fist','Zapek','Pikorage','Cockalypse','Gesticot','Terrakami','Figgon','Saladrake','Auberjaw','Scriptile','Pythagon','Dracoton','Tundragon','Apprenpti','Reptueur','Gardilisk','Puyotan','Invocamon','Gyaoon','Glaugoon','Limacide'],
	},
	{
